...
@Component
public class HousekeeperUIController {
...
//        System.out.println("FK received in FoodWorkerController: " + employee.getId());
    ...
    private void openForm(Housekeeper hk) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/modal-forms/add-housekeeper.fxml"));
            loader.setControllerFactory(applicationContext::getBean);
            Stage stage = new Stage();
            stage.initModality(Modality.APPLICATION_MODAL);
            stage.setTitle(hk == null ? "Add Housekeeper" : "Update Housekeeper");
            stage.setScene(new Scene(loader.load()));
            HousekeeperAddUIController controller = loader.getController();
