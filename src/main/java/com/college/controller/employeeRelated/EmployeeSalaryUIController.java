package com.college.controller.employeeRelated;
...
@Component
public class EmployeeSalaryUIController {
    ...
    private void openForm(EmployeeSalary employeeSalary) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/modal-forms/add-employeeSalary.fxml"));
            ...
            EmployeeSalaryAddUIController controller = loader.getController();
