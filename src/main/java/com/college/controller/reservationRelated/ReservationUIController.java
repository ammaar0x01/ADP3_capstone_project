package com.college.controller.reservationRelated;
...
// Employee ID column
    ...
    private void add() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/modal-forms/add-reservation.fxml"));
            loader.setControllerFactory(MainFinal.getSpringContext()::getBean);

            Parent root = loader.load();
            ReservationAddUIController addController = loader.getController();
    ...
    private void update() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/modal-forms/update-reservation.fxml")); // Use a dedicated FXML for editing
            loader.setControllerFactory(MainFinal.getSpringContext()::getBean);

            Parent root = loader.load();
            ReservationUpdateUIController editController = loader.getController();
